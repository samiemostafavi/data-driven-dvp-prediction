function dt = getServiceTimeCompute(servicefunction,servicerate,randomseed)
    ...
    if isempty(rs_state)
        ...
        rs_state = initRandStream(15973+randomseed);
    end
    ...
    rand_struct = getRandFromState(rs_state,15973+randomseed,1);
