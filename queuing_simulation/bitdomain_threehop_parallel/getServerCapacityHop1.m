function capacity = getServerCapacityHop1(mean,time_slot_duration,snr,w,randomseed)
    ...
    if isempty(rs_state)
        ...
        rs_state = initRandStream(67890+randomseed);
    end
    ...
    rand_struct = getRandFromState(rs_state,67890+randomseed,1);
